This project investigates the simulation of innovation diffusion through Generative Agent-Based Modeling (GABM), based on Everett Rogers' Diffusion of Innovations theory, focusing on the decision stage and with some simplifications. By employing advanced AI agent frameworks, particularly AutoGen, the system enables agents to simulate human-like reasoning, adaptive decision-making and socially responsive behavior. The simulation models the spread of innovation across social networks, incorporating rich behavioral profiles to reflect individual and group dynamics.

The focus of the project is not only trying to simulate the diffusion of innovation but also to explore how generative agents can be used to model complex social phenomena and decision-making processes.
